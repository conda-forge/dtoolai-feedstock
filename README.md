...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dtoolai-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13806&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dtoolai-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dtoolai` can be installed with:

```
conda install dtoolai
```

It is possible to list all of the versions of `dtoolai` available on your platform with:
